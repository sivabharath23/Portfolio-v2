const projects = [
  ...
  // ── OTHER PROJECTS ─────────────────────────────────────────────────────────
  {
    ...
    description:
      'Enterprise resource planning platform for managing inventory, sales, purchases, vendors, customers, staff, and business reports from a centralized dashboard.',
  ...
  },
  {
    ...
    subtitle: 'Orders, Tables & Kitchen Workflow',
    description:
      'Restaurant operations software for table management, menu items, food orders, kitchen status, billing, and daily sales tracking with a responsive interface.',
    tags: ['React', 'Express', 'MongoDB', 'REST API'],
    github: 'https://github.com/sivabharath23',
    live: null,
    featured: false,
    emoji: 'RMS',
    accent: 'from-rose-600/20 to-amber-600/10',
    badge: 'MERN',
    demoNote: null,
  },
  {
    title: 'Retail POS Billing Software',
    subtitle: 'Sales, Invoice & Stock Billing',
    description:
      'Retail billing system for fast checkout, invoice generation, product catalog management, customer records, stock updates, and sales summaries.',
    tags: ['React', 'Node.js', 'MongoDB', 'PDF Billing'],
    github: 'https://github.com/sivabharath23',
    live: null,
    featured: false,
    emoji: 'POS',
    accent: 'from-emerald-600/20 to-lime-600/10',
    badge: 'Billing',
    demoNote: null,
  },
]
